...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'meta.meta', false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    object: Schema.Attribute.Relation<'oneToOne', 'api::object.object'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLoyaltyProgramLoyaltyProgram
  ...
  attributes: {
    ...
    >;
    objects: Schema.Attribute.Relation<'oneToMany', 'api::object.object'>;
    program: Schema.Attribute.Component<'components.program', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiObjectCategoryObjectCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'object_categories';
  info: {
    displayName: '\u041A\u0430\u0442\u0435\u0433\u043E\u0440\u0438\u0438 \u043E\u0431\u044A\u0435\u043A\u0442\u043E\u0432';
    pluralName: 'object-categories';
    singularName: 'object-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::object-category.object-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    objects: Schema.Attribute.Relation<'oneToMany', 'api::object.object'>;
...
export interface ApiObjectObject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'features.osobennosti', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::object.object'>;
    ...
    loyalty_member: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    loyalty_program: Schema.Attribute.Relation<
      'manyToOne',
      'api::loyalty-program.loyalty-program'
    >;
    object_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::object-category.object-category'
    >;
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'\u041E\u0442\u0435\u043B\u044C'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: '\u0421\u043F\u0435\u0446\u0438\u0430\u043B\u044C\u043D\u044B\u0435 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u044F';
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    object: Schema.Attribute.Relation<'manyToOne', 'api::object.object'>;
...
export interface ApiSystemSystem extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    error: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::system.system'
...
export interface ApiVacancyLocationVacancyLocation
  extends Struct.CollectionTypeSchema {
  collectionName: 'vacancy_locations';
  info: {
    displayName: '\u041B\u043E\u043A\u0430\u0446\u0438\u0438 \u0432\u0430\u043A\u0430\u043D\u0441\u0438\u0439';
    pluralName: 'vacancy-locations';
    singularName: 'vacancy-location';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vacancy-location.vacancy-location'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVacancyVacancy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vacancy_location: Schema.Attribute.Relation<
      'manyToOne',
      'api::vacancy-location.vacancy-location'
    >;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::vacancy-location.vacancy-location': ApiVacancyLocationVacancyLocation;
